...
static Node* getNode(LinkedList* this, int nodeIndex)
{
	...
	if(this != NULL && nodeIndex>= 0 && nodeIndex < this->size)
	{
		...
		{
			pNodo = pNodo->pNextNode;//obtenemos el ultiimo nodo
		}
...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this != NULL && nodeIndex>= 0 && nodeIndex <= this->size)
    {
    	pNodo = malloc(sizeof(pNodo));//reservamos memoria para el nuevo nodo
    	if(pNodo == NULL)
    	{
    		returnAux = -1;
    	}
    	...
    	{
    		returnAux = 0;
    		this->size++;//aumentamos el tamaños de la ll
    		pNodo->pElement = pElement;//paso el elemento
...
int ll_add(LinkedList* this, void* pElement)
{
   int returnAux = -1;
    ...
    if(this != NULL)
    {
    	addNode(this,ll_len(this),pElement);//agregamos el nodo
...
void* ll_get(LinkedList* this, int index)
{
   void* returnAux = NULL;
    ...
    if(this != NULL && index>=0 && index<ll_len(this))
    {
    	...
    	returnAux = pNodo->pElement;//retornamos e elemento del nodo
    }
    return returnAux;
}
...
int ll_set(LinkedList* this, int index,void* pElement)
{
   int returnAux = -1;
    ...
    {
    	pNodo = getNode(this,index);//obtenemos el nodo
    	pNodo->pElement = pElement;//modifica el elemento del nodo obtenido
    	returnAux = 0;
    }
    return returnAux;
}
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index>=0 && index<ll_len(this))
    {
    	if(index == 0)//si queremos remover el primer nodo
    	{
    		pNodo = this->pFirstNode; //hacemos eque el primer nodo apunte a la direccion de memoria del 2do
    		this->pFirstNode = pNodo->pNextNode;
    	}
    	else if(index>0 && index<=ll_len(this))
    	{
    		pNodo = getNode(this,index);//obtenemos el nodo
    		pNodoAnterior = getNode(this,index-1);//obtenemos el nodo anterior
    		pNodoAnterior->pNextNode = pNodo->pNextNode;//el nodo apunta a la direccion de memoria que apuntaba el nodo eliminado
    	}

    	free(pNodo);
    	this->size--; // achicamos el tamaños de ll
    	returnAux = 0;
    }
    return returnAux;
}
...
int ll_push(LinkedList* this, int index, void* pElement)
{
   int returnAux = -1;
    ...
    if(this != NULL && index>=0 && index<=ll_len(this)) //verifico que este dentro del primer y el ultimo nodo
    {
    	if(addNode(this,index,pElement)== 0)//agrego el nodo en la posicion indicada
		{
    		returnAux = 0;
		}
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
    	...
    	for(i=0; i<ll_len(this); i++)
    	{
    		auxElement = ll_get(this,i);//obtengo el nodo
    		if(auxElement == pElement)//verifico su contiene el elemento pasado
    		{
    			returnAux = 1;
    			break;
    		}
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
    	...
    	for(i=0; i<ll_len(this); i++)
    	{
    		auxElement = ll_get(this2,i);//obtengo los elementos del aux

    		if(ll_contains(this,auxElement)==0)//verifico que esten contenidos en this
    		{
    			returnAux = 0;
    			break;
    		}
